              ...
              <div className="space-y-8">
                <div className="relative pl-8 border-l border-border/60">
                  ...
                  <p className="text-muted-foreground mt-4">
                    Passionate full-stack developer with a B.Tech in Computer Science (CGPA: 8.74/10) and hands-on experience building web applications. Specialize in creating responsive, user-centric interfaces with modern web technologies.
                  </p>
                </div>
